...
abstract class ReplaySpec extends WordSpec with MustMatchers {
  ...
  class Fixture {
    ...
    processor1 ! Message(Increment)
    val f11 = (processor1 ? Snapshot).mapTo[SnapshotSaved]
    processor1 ! Message(Increment)
    processor1 ! Message(Increment)
    val f12 = (processor1 ? Snapshot).mapTo[SnapshotSaved]
    processor1 ! Message(Increment)
    ...
    val f21 = (processor2 ? Snapshot).mapTo[SnapshotSaved]
    processor2 ! Message(Increment)
    val f22 = (processor2 ? Snapshot).mapTo[SnapshotSaved]
